...
$sendingAccountUsername    = 'rahulravi1026@gmail.com';
$sendingAccountPassword    = 'rarerora1026122719751968';

// Recipient (To:) Details - Change this to the email details of who will receive all the emails from the website.
$recipientEmail            = 'dreambigorg2021@gmail.com';      // Where to send the admin email.
$recipientName             = 'Rahul Ravi'; // Name of admin to receive email from website.

// Email details - Change these to suit your website needs
$emailSubject              = 'Dream Big Website Contact Form Response'; // Subject of the email that the admin will see.
$websiteName               = 'Dream Big Website Contact Form Response';       // This is used as the "From name".
...
$confirmationFromName      = "Ink and Metal";         // Used in the "from" field of the email.
$confirmationReplyTo       = "inkandmetal5773@gmail.com";  // If the user wants to reply to the confirmation email, where should it go?
